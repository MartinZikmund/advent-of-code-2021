...
SnailfishNumber? currentNumber = null;

foreach (var line in lines)
{
    var number = SnailfishNumber.Parse(line);
...
Console.WriteLine(currentNumber!.Magnitude);
...
public class SnailfishNumber
{
    ...
    {
        var pair = new SnailfishNumber(left, right);
